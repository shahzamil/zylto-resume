<script lang="ts">
	...
	const personLd = {
		...
		'@type': 'Person',
		name: 'Muzzamil Shahzad',
		url: 'https://github.com/shahzamil',
		sameAs: ['https://github.com/shahzamil'],
...
<SeoHead
	title="About | Zylto"
	description="Learn about Zylto, the free open-source tool that simulates how real enterprise ATS platforms parse and score your resume."
/>
...
<main class="about">
	...
	<div class="container">
		...
		<section class="about-hero">
			...
			<h1 class="hero-title">
				Built Because Resume Screeners
		...
		<section class="section">
			...
			<h2>Why Existing ATS Checkers Fail You</h2>
			<div class="problem-grid">
				...
				<div class="problem-card">
					...
					<p>
						...
						website. Where does that data go? Who has access? Zylto parses your files entirely
						client-side. Only extracted text is sent to Google Gemini for AI scoring.
					</p>
				</div>
				<div class="problem-card">
					<div class="problem-icon">
		...
		<section class="section">
			...
			<h2>How Zylto Works Differently</h2>
			<div class="approach-list">
				<div class="approach-item">
					...
					<div class="approach-content">
						...
						<p>
							Instead of hard-coded keyword matching, Zylto uses large language models to
				...
				<div class="approach-item">
					...
					<div class="approach-content">
						...
						<p>
							Zylto simulates Workday, Taleo (Oracle), iCIMS, Greenhouse, Lever, and SAP
		...
		<section class="section open-source-section">
			<div class="open-source-card">
				...
				<div class="os-links">
					<a
						href="https://github.com/shahzamil/zylto-resume"
						target="_blank"
						rel="noopener"
					...
					<a
						href="https://github.com/shahzamil/zylto-resume/issues"
						target="_blank"
						rel="noopener"
		...
		<section class="section">
			...
			<h2>Zylto by Muzzamil Shahzad</h2>
			<div class="creator-card">
				<div class="creator-info">
					<p>
						Zylto is built and maintained by Muzzamil Shahzad for job seekers and recruiters. It
						combines six-platform ATS simulation with practical, AI-assisted resume feedback.
					</p>
					<div class="creator-links">
						<a
							href="https://github.com/shahzamil"
							target="_blank"
							rel="noopener"
							class="creator-link"
						>
						...
						<a
							href="https://www.linkedin.com/in/shahzamil/"
							target="_blank"
							rel="noopener"
							class="creator-link"
						>
...
<style>
	...
	.orb-1 {
		width: 500px;
		height: 500px;
		background: rgba(116, 206, 0, 0.06);
		top: 5%;
		left: -10%;
	}
	...
	.section-badge {
		...
		background: rgba(116, 206, 0, 0.08);
		border: 1px solid rgba(116, 206, 0, 0.15);
		border-radius: var(--radius-full);
		font-size: 0.75rem;
		font-weight: 600;
		color: var(--accent-cyan);
	...
	.approach-item:hover {
		border-color: rgba(116, 206, 0, 0.2);
	}
	...
	.os-btn.primary:hover {
		...
		box-shadow: 0 0 20px rgba(116, 206, 0, 0.3);
		color: var(--color-bg-primary);
	}
