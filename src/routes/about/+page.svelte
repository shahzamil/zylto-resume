		...
		<section class="section">
			...
			<div class="creator-card">
				<div class="creator-info">
					<p>
						Zylto is adapted for job seekers and recruiters by Muzzamil Shahzad. Its six-platform
						scoring engine is built on the MIT-licensed ATS Screener project created by Sunny Patel.
					</p>
