...
<SeoHead
	title="Sign In | Zylto"
	description="Sign in to Zylto to scan your resume across 6 real ATS platforms and track your score history."
/>
...
<style>
	...
	.field-input:focus {
		...
		box-shadow: 0 0 0 3px rgba(116, 206, 0, 0.15);
	}
	...
	.submit-btn:hover:not(:disabled) {
		...
		box-shadow:
			0 0 24px rgba(116, 206, 0, 0.3),
			0 0 48px rgba(168, 255, 36, 0.1);
	}
