...
function tierColor(score: number): string {
	if (score >= 80) return '#287a3d';
	if (score >= 60) return '#8a6500';
	if (score >= 40) return '#a84708';
	return '#b42335';
}
	...
	const tree = {
		...
		props: {
			style: {
				...
				background: 'linear-gradient(135deg, #ffffff 0%, #f7f8f9 50%, #eef1f3 100%)',
				color: '#101112',
				padding: '64px 72px',
			...
			children: [
				...
				// footer
				{
					...
					props: {
						...
						children: ['Free • Open source • No paywalls', 'zylto-ats-resume-checker.vercel.app']
					}
				}
			]
		}
