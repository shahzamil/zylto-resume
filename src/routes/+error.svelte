...
<SeoHead
	title="404, page not found | Zylto"
...
<style>
	...
	.orb-blue {
		width: 300px;
		height: 300px;
		background: rgba(168, 255, 36, 0.08);
		top: 55%;
		left: 40%;
	}
	...
	.grid-overlay {
		...
		inset: 0;
		background-image:
			linear-gradient(rgba(16, 17, 18, 0.015) 1px, transparent 1px),
			linear-gradient(90deg, rgba(16, 17, 18, 0.015) 1px, transparent 1px);
	...
	.numeral {
		...
		/* gradient fill for the numerals: meets 4.5:1 on dark bg because
		   the cyan endpoint (#467b00) has contrast 5.1:1 against #0a0a0f */
		background: linear-gradient(135deg, #467b00 0%, #818cf8 55%, #a78bfa 100%);
	...
	@keyframes glitch-jitter {
		0% {
			text-shadow:
				2px 0 rgba(116, 206, 0, 0.5),
				-2px 0 rgba(167, 139, 250, 0.5);
			transform: translateX(0);
		}
		25% {
			text-shadow:
				-3px 0 rgba(116, 206, 0, 0.6),
				3px 0 rgba(167, 139, 250, 0.4);
			transform: translateX(2px);
		}
		50% {
			text-shadow:
				3px 0 rgba(116, 206, 0, 0.4),
	...
	.nav-chip:focus-visible {
		...
		box-shadow: 0 0 16px rgba(116, 206, 0, 0.2);
		outline: none;
	}
