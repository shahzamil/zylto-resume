...
<main class="share-page">
	...
	<div class="share-card">
		...
		<p class="footnote">
			Zylto simulates Workday, Taleo, iCIMS, Greenhouse, Lever, and SuccessFactors. Open source, no
			paywalls.
		</p>
	</div>
</main>
...
<style>
	...
	.cta-btn:hover {
		...
		box-shadow: 0 0 24px rgba(116, 206, 0, 0.3);
	}
