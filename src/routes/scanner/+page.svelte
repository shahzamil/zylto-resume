...
<style>
	...
	.paste-block {
		...
		border: 1px dashed rgba(116, 206, 0, 0.25);
	...
	.paste-block:hover,
	.paste-block[open] {
		border-color: rgba(116, 206, 0, 0.5);
		background: rgba(116, 206, 0, 0.04);
	}
	...
	.btn-scan:hover:not(:disabled) {
		...
		box-shadow:
			0 0 30px rgba(116, 206, 0, 0.3),
			0 0 60px rgba(168, 255, 36, 0.15);
	}
	...
	.step-line.done {
		background: linear-gradient(90deg, rgba(34, 197, 94, 0.5), rgba(116, 206, 0, 0.3));
	}
