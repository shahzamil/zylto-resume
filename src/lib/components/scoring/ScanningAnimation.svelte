<script lang="ts">
	...
	const platforms = [
		{ name: 'Workday', vendor: 'Workday Inc.', color: '#467b00' },
		{ name: 'Taleo', vendor: 'Oracle', color: '#8a5a00' },
		{ name: 'iCIMS', vendor: 'iCIMS', color: '#a8ff24' },
		{ name: 'Greenhouse', vendor: 'Greenhouse', color: '#287a3d' },
		{ name: 'Lever', vendor: 'Employ', color: '#2e6f40' },
		{ name: 'SuccessFactors', vendor: 'SAP', color: '#8a5a00' }
	];
...
<style>
	...
	.orbit-dot {
		...
		box-shadow: 0 0 10px rgba(116, 206, 0, 0.6);
	}
