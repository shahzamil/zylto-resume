...
<style>
	...
	.orb-2 {
		width: 500px;
		height: 500px;
		background: rgba(168, 255, 36, 0.1);
		top: 40%;
		right: -15%;
		animation-delay: -7s;
	}
	...
	.grid-overlay {
		...
		inset: 0;
		background-image:
			linear-gradient(rgba(16, 17, 18, 0.02) 1px, transparent 1px),
			linear-gradient(90deg, rgba(16, 17, 18, 0.02) 1px, transparent 1px);
	...
	.btn-primary:hover {
		...
		box-shadow:
			0 0 40px rgba(116, 206, 0, 0.35),
			0 0 80px rgba(168, 255, 36, 0.15);
		color: var(--color-bg-primary);
	}
	...
	.btn-shimmer {
		position: absolute;
		inset: 0;
		background: linear-gradient(90deg, transparent, rgba(16, 17, 18, 0.2), transparent);
