	...
	const features = [
		{
			...
			gradient: 'linear-gradient(135deg, #467b00, #a8ff24)'
		},
		{
			icon: 'search',
			...
			gradient: 'linear-gradient(135deg, #a8ff24, #2e6f40)'
		},
		{
			icon: 'chart',
			...
			gradient: 'linear-gradient(135deg, #2e6f40, #a92668)'
		},
		{
			icon: 'sparkles',
			...
			gradient: 'linear-gradient(135deg, #a92668, #a84708)'
		},
		{
			icon: 'globe',
			...
			gradient: 'linear-gradient(135deg, #a84708, #8a6500)'
		},
		{
			icon: 'shield',
			title: 'Privacy First',
			...
			gradient: 'linear-gradient(135deg, #287a3d, #467b00)'
		}
	];
