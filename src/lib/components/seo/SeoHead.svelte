<script lang="ts">
	...
	let {
		...
		ogImageAlt = 'Zylto: free open-source resume scoring against 6 real ATS platforms.',
		ogType = 'website',
		canonical,
		noIndex = false
	}: Props = $props();
	...
	const PRODUCTION_HOST = 'zylto-ats-resume-checker.vercel.app';
...
<svelte:head>
	...
	<meta property="og:site_name" content="Zylto" />
