...
description: The 6 enterprise ATS platforms simulated by Zylto and how they differ.
---

Zylto simulates scoring from 6 of the most widely deployed enterprise Applicant Tracking Systems. Each platform has fundamentally different approaches to parsing, filtering, and ranking candidates.
