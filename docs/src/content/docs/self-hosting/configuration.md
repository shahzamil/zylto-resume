...
How users sign in (or whether they sign in at all) is a separate choice from the LLM provider, and it's also driven by environment variables. Zylto supports three modes, picked automatically:
