...
self-host authentication cycle: active directory / ldap sign-in (closes [#16](https://github.com/shahzamil/zylto-resume/issues/16)) and a true firebase-free self-host (closes [#13](https://github.com/shahzamil/zylto-resume/issues/13)). purely additive: the hosted firebase deployment is byte-identical, and the anonymous self-host path is unchanged.
