...
describe('classifyScore tiers', () => {
	...
	it('returns hex colors matching tiers', () => {
		expect(classifyScore(85).color).toBe('#287a3d');
		expect(classifyScore(70).color).toBe('#8a6500');
		expect(classifyScore(50).color).toBe('#a84708');
		expect(classifyScore(20).color).toBe('#b42335');
	});
